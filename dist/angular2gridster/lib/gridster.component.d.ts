...
export declare class GridsterComponent implements OnInit, AfterContentInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<GridsterComponent, "ngx-gridster", never, { "options": "options"; "draggableOptions": "draggableOptions"; "parent": "parent"; }, { "optionsChange": "optionsChange"; "ready": "ready"; "reflow": "reflow"; "prototypeDrop": "prototypeDrop"; "prototypeEnter": "prototypeEnter"; "prototypeOut": "prototypeOut"; }, never, ["*"]>;
}
